...
export default async function CookiesPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const marketing: CookieRow[] = [
    { name: "_gcl_au", purpose: "Google Ads conversion linker  -  measures ad clicks that lead to the site. Only set after you accept marketing cookies.", duration: "90 days" },
    { name: "_gcl_aw, _gcl_dc", purpose: "Google Ads click identifiers for conversion measurement. Only set after you accept marketing cookies.", duration: "90 days" },
  ];
