...
const QUICK_REPLY_MAP: Record<string, string> = {
  ...
  "prices": "prices cost rates",
  "airport pickup": "airport delivery JNX",
  "port pickup": "port ferry delivery",
  "book airport pickup": "airport delivery JNX book",
  "book port pickup": "port ferry delivery book",
  "book now": "book reserve booking",
  "whatsapp us": "contact whatsapp phone",
  "licence info": "license licence permit documents",
  "license info": "license licence permit documents",
  "minimum age": "age minimum years old",
  "insurance info": "insurance coverage CDW damage",
  "deposit info": "deposit credit card hold",
  "cancellation policy": "cancel refund cancellation policy",
  "rental terms": "cancel terms policy",
  "atv & buggy": "atv quad buggy",
  "atvs & buggies": "atv quad buggy",
  "scooters": "scooter moped piaggio",
  "jeeps & 4×4s": "jeep 4x4 jimny off-road",
  "jeeps & 4x4s": "jeep 4x4 jimny off-road",
