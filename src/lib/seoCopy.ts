...
export const SEO_COPY: Record<string, LocaleSeoCopy> = {
  home: {
    en: {
      title: "Rent a Car Naxos | Best Car Rental Naxos | Free Airport Delivery",
      description: "Rent a car in Naxos with free delivery to the airport, port, and your hotel. Low prices, unlimited kilometers, automatic and manual cars, family-owned since 2018.",
    ...
    el: {
      title: "Ενοικίαση Αυτοκινήτου Νάξος | Rent a Car Naxos | Δωρεάν Παράδοση",
      description: "Νοικιάστε αυτοκίνητο στη Νάξο με δωρεάν παράδοση σε αεροδρόμιο, λιμάνι και ξενοδοχείο. Διαφανείς τιμές, απεριόριστα χιλιόμετρα, αυτόματα και χειροκίνητα.",
      keywords: ["ενοικίαση αυτοκινήτου Νάξος", "rent a car Naxos", "ενοικιάσεις αυτοκινήτων Νάξος", "αυτοκίνητα Νάξος"],
    },
    it: {
      title: "Noleggio Auto Naxos | Rent a Car Naxos | Consegna Gratuita",
      description: "Noleggia un'auto a Naxos con consegna gratuita all'aeroporto, al porto e in hotel. Prezzi bassi, chilometri illimitati, auto automatiche e manuali.",
      keywords: ["noleggio auto Naxos", "rent a car Naxos", "noleggio auto aeroporto Naxos"],
    },
    fr: {
      title: "Location Voiture Naxos | Rent a Car Naxos | Livraison Gratuite",
      description: "Louez une voiture à Naxos avec livraison gratuite à l'aéroport, au port et à l'hôtel. Prix transparents, kilométrage illimité, voitures automatiques et manuelles.",
      keywords: ["location voiture Naxos", "rent a car Naxos", "louer voiture Naxos"],
    },
    de: {
      title: "Autovermietung Naxos | Mietwagen Naxos | Gratis Lieferung",
      description: "Mieten Sie ein Auto auf Naxos mit kostenloser Lieferung zu Flughafen, Hafen und Hotel. Günstige Preise, unbegrenzte Kilometer, Automatik und Manuell.",
      keywords: ["Autovermietung Naxos", "Mietwagen Naxos", "Auto mieten Naxos"],
    },
  },
  fleet: {
    en: { title: "Naxos Car Rental Fleet - SUV, Automatic, Compact & Family", description: "Browse our Naxos car rental fleet: compact and economy cars, automatic and manual hatchbacks, spacious SUVs, and 7-seater family vans. Free delivery island-wide." },
    el: { title: "Στόλος Ενοικιάσεων Αυτοκινήτων Νάξου - SUV, Αυτόματα, Compact", description: "Δείτε τον στόλο αυτοκινήτων μας στη Νάξο: μικρά και οικονομικά, αυτόματα και χειροκίνητα hatchback, SUV και 7-θέσια van. Δωρεάν παράδοση." },
    it: { title: "Flotta Noleggio Auto Naxos - SUV, Automatiche, Compatte", description: "Esplora la nostra flotta auto a Naxos: city car, automatiche, berline, SUV spaziosi e van familiari a 7 posti. Consegna gratuita ovunque sull'isola." },
    fr: { title: "Flotte de Location Voiture Naxos - SUV, Automatique, Compacte", description: "Découvrez notre flotte de voitures à Naxos : citadines, automatiques, familiales, SUV et monospaces 7 places. Livraison gratuite sur toute l'île." },
    de: { title: "Mietwagenflotte Naxos - SUV, Automatik, Kleinwagen & Familie", description: "Entdecken Sie unsere Fahrzeugflotte auf Naxos: Kleinwagen, Automatikautos, SUVs und 7-Sitzer Familienvans. Inselweit kostenlose Lieferung." },
  },
  "fleet/cars": {
