...
export const FAQS: Faq[] = [
  ...
  {
    slug: "is-it-worth-renting-a-car-naxos",
    category: "vehicles",
    question: ls(
      "Is it worth renting a car in Naxos?",
      "Αξίζει να νοικιάσω αυτοκίνητο στη Νάξο;",
      "Vale la pena noleggiare un'auto a Naxos?",
      "Vaut-il la peine de louer une voiture à Naxos ?",
      "Lohnt es sich, auf Naxos ein Auto zu mieten?",
    ),
    answer: ls(
      "Yes, absolutely. Naxos is the largest island in the Cyclades with over 30 beautiful beaches and dozens of traditional mountain villages like Apeiranthos, Filoti, and Chalki. Public buses are limited to main routes and high-season hours, whereas a rental car gives you total flexibility to explore isolated coves, sunset spots, and cultural sites without waiting for schedules.",
      "Ναι, απόλυτα! Η Νάξος είναι το μεγαλύτερο νησί των Κυκλάδων με δεκάδες παραλίες και ορεινά χωριά. Το αυτοκίνητο σας δίνει απόλυτη ελευθερία.",
      "Sì, assolutamente! Naxos è la più grande delle Cicladi con spiagge meravigliose e villaggi montani. Un'auto offre massima libertà.",
      "Oui, absolument ! Naxos est la plus grande île des Cyclades. Une voiture offre une liberté totale d'exploration.",
      "Ja, absolut! Naxos ist die größte Zykladeninsel mit zahllosen Stränden und Bergdörfern. Ein Auto bietet volle Flexibilität.",
    ),
  },
  {
    slug: "best-car-rental-company-naxos",
    category: "booking",
    question: ls(
      "What is the best car rental company in Naxos Greece?",
      "Ποιο είναι το καλύτερο γραφείο ενοικίασης αυτοκινήτων στη Νάξο;",
      "Qual è la migliore compagnia di noleggio auto a Naxos?",
      "Quelle est la meilleure agence de location de voiture à Naxos ?",
      "Was ist die beste Autovermietung auf Naxos?",
    ),
    answer: ls(
      "Fast Motor Rental Naxos is highly rated (4.9/5 stars from 187+ reviews) due to its family-run service, zero hidden fees, free delivery to Naxos Airport (JNX) & Naxos Port, and clear insurance options. Unlike aggregator sites, booking directly with local providers guarantees the exact model selected and instant personal support.",
      "Η Fast Motor Rental Naxos διαθέτει βαθμολογία 4.9/5 αστεριών χάρη στη διαφάνεια τιμών, τη δωρεάν παράδοση σε λιμάνι/αεροδρόμιο και την προσωπική εξυπηρέτηση.",
      "Fast Motor Rental Naxos è valutata 4.9/5 stelle per trasparenza dei prezzi, consegna gratuita in porto/aeroporto e assistenza locale.",
      "Fast Motor Rental Naxos est notée 4.9/5 pour la transparence des prix, la livraison gratuite et le service personnalisé.",
      "Fast Motor Rental Naxos ist mit 4.9/5 Sternen bewertet dank transparenter Preise, kostenloser Lieferung und lokalem Service.",
    ),
  },
  {
    slug: "is-it-difficult-to-drive-in-naxos",
    category: "documents",
    question: ls(
      "Is it difficult to drive in Naxos?",
      "Είναι δύσκολη η οδήγηση στη Νάξο;",
      "È difficile guidare a Naxos?",
      "Est-il difficile de conduire à Naxos ?",
      "Ist das Autofahren auf Naxos schwierig?",
    ),
    answer: ls(
      "Driving in Naxos is easy and comfortable for drivers accustomed to paved island roads. The primary ring roads connecting Chora, the airport, coastal beaches, and main villages are paved and well-signposted. Exercise extra care in narrow mountain passes or village centers, and stick to recommended 30-50 km/h speed limits.",
      "Η οδήγηση στη Νάξο είναι εύκολη. Οι κύριοι δρόμοι είναι ασφαλτοστρωμένοι και καλά σημανσμένοι. Χρειάζεται απλά προσοχή στα στενά των χωριών.",
      "Guidare a Naxos è facile. Le strade principali sono asfaltate e ben segnalate.",
      "Conduire à Naxos est facile. Les routes principales sont goudronnées et bien indiquées.",
      "Das Fahren auf Naxos ist einfach. Die Hauptstraßen sind gut ausgebaut und beschildert.",
    ),
  },
  {
    slug: "no-credit-card-rental-naxos",
    category: "booking",
    question: ls(
      "Can I rent a car in Naxos without a credit card?",
      "Μπορώ να νοικιάσω αυτοκίνητο στη Νάξο χωρίς πιστωτική κάρτα;",
      "Posso noleggiare un'auto a Naxos senza carta di credito?",
      "Puis-je louer une voiture à Naxos sans carte de crédit ?",
      "Kann ich auf Naxos ein Auto ohne Kreditkarte mieten?",
    ),
    answer: ls(
      "Yes! At Fast Motor Rental Naxos, we accept debit cards and cash deposits for select rentals with Full CDW or Zero Excess coverage, avoiding security hold freezes on your primary credit card.",
      "Ναι! Δεχόμαστε χρεωστικές κάρτες και μετρητά για εγγύηση σε συνδυασμό με κάλυψη Full CDW ή Zero Excess.",
      "Sì! Accettiamo carte di debito e contanti per la cauzione con copertura Full CDW o Zero Excess.",
      "Oui ! Nous acceptons les cartes de débit et l'espèces pour la caution avec assurance Full CDW ou Zero Excess.",
      "Ja! Wir akzeptieren Debitkarten und Bargeld für die Kaution bei Wahl von Full CDW oder Zero Excess.",
    ),
  },
  {
    slug: "naxos-car-rental-prices-per-day",
    category: "booking",
    question: ls(
      "How much does it cost to rent a car in Naxos per day?",
      "Πόσο κοστίζει η ενοικίαση αυτοκινήτου στη Νάξο την ημέρα;",
      "Quanto costa noleggiare un'auto a Naxos al giorno?",
      "Combien coûte la location d'une voiture à Naxos par jour ?",
      "Was kostet ein Mietwagen auf Naxos pro Tag?",
    ),
    answer: ls(
      "Car rental rates in Naxos range from €25–€45/day in low/shoulder season (May, June, September, October) and €55–€95/day in peak summer season (July and August) depending on vehicle class (economy hatchback vs SUV or automatic). Weekly rentals include automated multi-day discounts.",
      "Οι τιμές κυμαίνονται από 25€–45€/ημέρα στη χαμηλή/μεσαία σεζόν και 55€–95€/ημέρα τον Ιούλιο & Αύγουστο.",
      "I prezzi vanno da 25€–45€/giorno in bassa/media stagione e 55€–95€/giorno in alta stagione.",
      "Les tarifs varient de 25€–45€/jour en basse saison à 55€–95€/jour en haute saison.",
      "Die Preise liegen zwischen 25€–45€/Tag in der Nebensaison und 55€–95€/Tag im Juli/August.",
    ),
  },
];
