...
export const BUSINESS_FACTS: BusinessFacts = {
  ...
  reputation: {
    ...
    //
    // Read from the profile header on 2026-08-23 (4.9 from
    // 222); the previous count of 187 had gone stale. The single
    // source of truth is src/content/reviews-google.json, regenerated by
    // scripts/scrape-google-reviews.mjs + scripts/import-reviews.mjs. Note the
    // total counts ratings left without text, so it exceeds REVIEWS.length.
    rating: ownerVerified(
      { value: 4.9, count: 222, source: "Google" },
      owner("Google Business Profile", "https://www.google.com/maps?cid=4683627190655486374"),
    ),
  },
  policies: {
