...
export const dict: Dict = {
  ...
  cookie: {
    ...
    body: "Essential cookies keep the site working. With your consent we also use analytics cookies to understand which pages help travellers most, and Google Ads cookies to measure our advertising. You can change your mind any time.",
    accept: "Accept all",
